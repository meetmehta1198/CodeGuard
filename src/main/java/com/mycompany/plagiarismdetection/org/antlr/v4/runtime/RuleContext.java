...
public class RuleContext implements RuleNode {
	...
	public String toStringTree(Parser recog) {
        ...
        public List<String> JayTree(Parser recog) {
		return Trees.JayTree(this, recog);
	}
	...
	public String toStringTree(List<String> ruleNames) {
        ...
        public List<String> JayTree(List<String> ruleNames) {
		return Trees.JayTree(this, ruleNames);
	}
	...
	public String toStringTree() {
        ...
        public List<String> JayTree() {
		return JayTree((List<String>)null);
	}
	...
	public String toString() {
       ...
       /* public List<String> toString1() {
		return toString1((List<String>)null, (RuleContext)null); 
	}*/
	...
	public final String toString(Recognizer<?,?> recog) {
       ...
       /* public final List<String> toString1(Recognizer<?,?> recog) {
		return toString1(recog, ParserRuleContext.EMPTY);
	}*/
	...
	public final String toString(List<String> ruleNames) {
       ...
       /* public final List<String> toString1(List<String> ruleNames) {
                return toString1(ruleNames, null);
	}*/
	...
	public String toString(Recognizer<?,?> recog, RuleContext stop) {
       ...
       /* public List<String> toString1(Recognizer<?,?> recog, RuleContext stop) {
		String[] ruleNames = recog != null ? recog.getRuleNames() : null;
		List<String> ruleNamesList = ruleNames != null ? Arrays.asList(ruleNames) : null;
		return toString1(ruleNamesList, stop);
	}*/
    ...
    /*    public List<String> toString1(List<String> ruleNames, RuleContext stop) {
		//StringBuilder buf = new StringBuilder();
		...
		while (p != null && p != stop) {
			if (ruleNames == null) {
				if (!p.isEmpty()) {
					//buf.append(p.invokingState);
                                        String xx = String.valueOf(p.invokingState);
                                        ll.add(xx);
                                }
			}
			else {
